...
class DateTranslator
{
    public:
        ...
        // Pass in that date if you wish to set the DateBuffer to a particular date.
...
public:
    ...
    // This class provides no protection against being accessed from multiple threads simultaneously. Update & InexactUpdate rewrite the date buffer, so care should be taken to protect against simultaneous access.
