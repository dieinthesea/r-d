/*
  The methods of this class include initialising a static array of characters, 
  getting a copy of the accessed file, checking if access is allowed and authorising the request. 
  In addition, this class defines an internal class called IPComponentStr, 
  which is used to handle components of IP addresses.
*/
/*
